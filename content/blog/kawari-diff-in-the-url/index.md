...
<video class="img-light" autoplay loop muted playsinline title="Mini-map navigation demo" preload="none" src="img/minimap_light.webm"></video>
<video class="img-dark" autoplay loop muted playsinline title="Mini-map navigation demo" preload="none" src="img/minimap_dark.webm"></video>
